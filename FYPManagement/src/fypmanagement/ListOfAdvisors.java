 ...
 * @author Munawar Ali
 */
public class ListOfAdvisors extends javax.swing.JFrame {

    /**
     * Creates new form ListOfStudents
     */
    public ListOfAdvisors() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListOfAdvisors.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListOfAdvisors().setVisible(true);
            }
        });
    }
